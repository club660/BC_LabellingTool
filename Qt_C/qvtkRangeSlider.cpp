...
class qvtkRangeSliderPrivate
{
    Q_DECLARE_PUBLIC(qvtkRangeSlider);
protected:
    qvtkRangeSlider* const q_ptr;
public:
    ...
    qvtkRangeSliderPrivate(qvtkRangeSlider& object);
    void init();
    ...
    qvtkRangeSliderPrivate::Handles m_SelectedHandles;
...
private:
    Q_DISABLE_COPY(qvtkRangeSliderPrivate);
};

// --------------------------------------------------------------------------
qvtkRangeSliderPrivate::qvtkRangeSliderPrivate(qvtkRangeSlider& object)
    :q_ptr(&object)
{
...
// --------------------------------------------------------------------------
void qvtkRangeSliderPrivate::init()
{
    Q_Q(qvtkRangeSlider);
...
// --------------------------------------------------------------------------
qvtkRangeSliderPrivate::Handle qvtkRangeSliderPrivate::handleAtPos(const QPoint& pos, QRect& handleRect)const
{
    Q_Q(const qvtkRangeSlider);
...
//
int qvtkRangeSliderPrivate::pixelPosToRangeValue(int pos) const
{
    Q_Q(const qvtkRangeSlider);
    QStyleOptionSlider option;
    q->initStyleOption(&option);
...
//---------------------------------------------------------------------------
int qvtkRangeSliderPrivate::pixelPosFromRangeValue(int val) const
{
    Q_Q(const qvtkRangeSlider);
    QStyleOptionSlider option;
    q->initStyleOption(&option);
...
void qvtkRangeSliderPrivate::drawMinimumSlider(QStylePainter* painter) const
{
    Q_Q(const qvtkRangeSlider);
    QStyleOptionSlider option;
...
void qvtkRangeSliderPrivate::drawMaximumSlider(QStylePainter* painter) const
{
    Q_Q(const qvtkRangeSlider);
    QStyleOptionSlider option;
...
// --------------------------------------------------------------------------
qvtkRangeSlider::qvtkRangeSlider(QWidget* _parent)
    : QSlider(_parent)
    , d_ptr(new qvtkRangeSliderPrivate(*this))
{
    Q_D(qvtkRangeSlider);
    d->init();
}
...
// --------------------------------------------------------------------------
qvtkRangeSlider::qvtkRangeSlider(Qt::Orientation o,
...
// --------------------------------------------------------------------------
qvtkRangeSlider::qvtkRangeSlider(qvtkRangeSliderPrivate* impl, QWidget* _parent)
    : QSlider(_parent)
    , d_ptr(impl)
{
    Q_D(qvtkRangeSlider);
...
// --------------------------------------------------------------------------
qvtkRangeSlider::qvtkRangeSlider(qvtkRangeSliderPrivate* impl, Qt::Orientation o,
    QWidget* parentObject)
    :QSlider(o, parentObject)
    , d_ptr(impl)
{
...
// --------------------------------------------------------------------------
qvtkRangeSlider::~qvtkRangeSlider()
{
}

// --------------------------------------------------------------------------
int qvtkRangeSlider::minimumValue() const
{
    Q_D(const qvtkRangeSlider);
    return d->m_MinimumValue;
}

// --------------------------------------------------------------------------
void qvtkRangeSlider::setMinimumValue(int min)
{
    Q_D(qvtkRangeSlider);
...
// --------------------------------------------------------------------------
int qvtkRangeSlider::maximumValue() const
{
    Q_D(const qvtkRangeSlider);
...
// --------------------------------------------------------------------------
void qvtkRangeSlider::setMaximumValue(int max)
{
    Q_D(qvtkRangeSlider);
...
// --------------------------------------------------------------------------
void qvtkRangeSlider::setValues(int l, int u)
{
    Q_D(qvtkRangeSlider);
    const int minValue =
...
// --------------------------------------------------------------------------
int qvtkRangeSlider::minimumPosition() const
{
    Q_D(const qvtkRangeSlider);
...
// --------------------------------------------------------------------------
int qvtkRangeSlider::maximumPosition() const
{
    Q_D(const qvtkRangeSlider);
...
// --------------------------------------------------------------------------
void qvtkRangeSlider::setMinimumPosition(int l)
{
    Q_D(const qvtkRangeSlider);
...
// --------------------------------------------------------------------------
void qvtkRangeSlider::setMaximumPosition(int u)
{
    Q_D(const qvtkRangeSlider);
...
// --------------------------------------------------------------------------
void qvtkRangeSlider::setPositions(int min, int max)
{
    Q_D(qvtkRangeSlider);
...
// --------------------------------------------------------------------------
void qvtkRangeSlider::setSymmetricMoves(bool symmetry)
{
    Q_D(qvtkRangeSlider);
...
// --------------------------------------------------------------------------
bool qvtkRangeSlider::symmetricMoves()const
{
    Q_D(const qvtkRangeSlider);
...
// --------------------------------------------------------------------------
void qvtkRangeSlider::onRangeChanged(int _minimum, int _maximum)
{
    Q_UNUSED(_minimum);
    Q_UNUSED(_maximum);
    Q_D(qvtkRangeSlider);
...
// --------------------------------------------------------------------------
// Render
void qvtkRangeSlider::paintEvent(QPaintEvent*)
{
    Q_D(qvtkRangeSlider);
    QStyleOptionSlider option;
...
void qvtkRangeSlider::mousePressEvent(QMouseEvent* mouseEvent)
{
    Q_D(qvtkRangeSlider);
    ...
    QRect handleRect;
    qvtkRangeSliderPrivate::Handle handle_ = d->handleAtPos(mouseEvent->pos(), handleRect);

    if (handle_ != qvtkRangeSliderPrivate::NoHandle)
    {
        d->m_SubclassPosition = (handle_ == qvtkRangeSliderPrivate::MinimumHandle) ?
        ...
        mepos > minCenter && mepos < maxCenter)
    {
        ...
        {
            d->m_SelectedHandles =
                QFlags<qvtkRangeSliderPrivate::Handle>(qvtkRangeSliderPrivate::MinimumHandle) |
                QFlags<qvtkRangeSliderPrivate::Handle>(qvtkRangeSliderPrivate::MaximumHandle);
...
// --------------------------------------------------------------------------
// Standard Qt UI events
void qvtkRangeSlider::mouseMoveEvent(QMouseEvent* mouseEvent)
{
    Q_D(qvtkRangeSlider);
...
void qvtkRangeSlider::mouseReleaseEvent(QMouseEvent* mouseEvent)
{
    Q_D(qvtkRangeSlider);
    this->QSlider::mouseReleaseEvent(mouseEvent);

    setSliderDown(false);
    d->m_SelectedHandles = qvtkRangeSliderPrivate::NoHandle;

    this->update();
}

// --------------------------------------------------------------------------
bool qvtkRangeSlider::isMinimumSliderDown()const
{
    Q_D(const qvtkRangeSlider);
    return d->m_SelectedHandles & qvtkRangeSliderPrivate::MinimumHandle;
}

// --------------------------------------------------------------------------
bool qvtkRangeSlider::isMaximumSliderDown()const
{
    Q_D(const qvtkRangeSlider);
    return d->m_SelectedHandles & qvtkRangeSliderPrivate::MaximumHandle;
}

// --------------------------------------------------------------------------
void qvtkRangeSlider::initMinimumSliderStyleOption(QStyleOptionSlider* option) const
{
    this->initStyleOption(option);
}

// --------------------------------------------------------------------------
void qvtkRangeSlider::initMaximumSliderStyleOption(QStyleOptionSlider* option) const
{
    this->initStyleOption(option);
}

// --------------------------------------------------------------------------
QString qvtkRangeSlider::handleToolTip()const
{
    Q_D(const qvtkRangeSlider);
...
// --------------------------------------------------------------------------
void qvtkRangeSlider::setHandleToolTip(const QString& _toolTip)
{
    Q_D(qvtkRangeSlider);
...
// --------------------------------------------------------------------------
bool qvtkRangeSlider::event(QEvent* _event)
{
    Q_D(qvtkRangeSlider);
    switch (_event->type())
    {
