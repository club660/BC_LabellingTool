#ifndef __qvtkRangeSlider_h
#define __qvtkRangeSlider_h
...
class qvtkRangeSlider : public QSlider
{
	Q_OBJECT
...
public:
	...
	explicit qvtkRangeSlider(Qt::Orientation o, QWidget* par = 0);
	explicit qvtkRangeSlider(QWidget* par = 0);
	virtual ~qvtkRangeSlider();
...
protected:
	qvtkRangeSlider(qvtkRangeSliderPrivate* impl, Qt::Orientation o, QWidget* par = 0);
	qvtkRangeSlider(qvtkRangeSliderPrivate* impl, QWidget* par = 0);
...
protected:
	QScopedPointer<qvtkRangeSliderPrivate> d_ptr;

private:
	Q_DECLARE_PRIVATE(qvtkRangeSlider);
	Q_DISABLE_COPY(qvtkRangeSlider);
};
